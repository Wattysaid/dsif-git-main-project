...
│                         loan_approval_scoring and configuration for tools like black
│
...
│
└── loan_approval_scoring   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes loan_approval_scoring a Python module
    │
